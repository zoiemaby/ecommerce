...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; margin:0; padding:0; font-family:'Poppins',sans-serif }
    ...
    .btn:hover { background: white; color: hsl(158, 82%, 15%); }
    .register-link { margin-top: 12px; text-align: center; }
    ...
    .loader {
      ...
      border-radius: 50%;
      border-top: 3px solid hsl(158, 82%, 15%);
      width: 18px;
      height: 18px;
...
<body>
  <div class="wrapper">
    <form id="loginForm" action="../actions/login_user.php" method="post">
      ...
      <button type="submit" class="btn">Login <span class="loader" id="loader"></span></button>
  ...
  <script>
    document.getElementById("loginForm").addEventListener("submit", function(event) {
            ...
            // Email validation (ashesi.edu.gh domain)
      ...
      form.addEventListener('submit', function (e) {
        ...
        .then(async (res) => {
          ...
          if (json.status === 'success') {
            ...
            setTimeout(function () {
              window.location.href = '/dashboard.php'; // <-- change this to your real landing page
            }, 800);
          } else {
